...
| openbdap | catalog | ckan | catalog-watch | RED | - | dipendenti-pubblici, bdap-lea |
...
- `openbdap`: Probe exception non gestita: ReadTimeout: HTTPSConnectionPool(host='bdap-opendata.rgs.mef.gov.it', port=443): Read timed out. (read timeout=10)
