...
| dati_cultura | catalog | sparql | catalog-watch | YELLOW | 502 | - |
...
- `dati_cultura`: HTTP 502 | content-type: text/html | url finale: https://dati.cultura.gov.it/sparql | Retry timeout/connection: RED
